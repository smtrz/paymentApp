package com.highbryds.washer.Helpers
...
object UIHelper {
    ...
    fun showAlertDialogWithEditText(
        message: String, title: CharSequence,
        context: Context?, callback: getStringDataFromEditText
    ) {
        ...
        dialog.setMessage(message)
            ...
            .setPositiveButton("OK") { _, _ ->
                ...
                callback.getData(editTextInput)
    ...
    fun showArrayInDialog(
        context: Context,
        data: ArrayList<String>,
        getselection: getSelectedItemsFromDialog, type: String
    ) {
        val arrayAdapter =
        ...
        val builder = AlertDialog.Builder(context)
        builder.setTitle("Choose from the below")

        builder.setAdapter(arrayAdapter, { dialogInterface, i ->
            if (type.equals("color")) {
                getselection.getColor(data.get(i))


            } else {

                getselection.getPreferredTimings(data.get(i))
            }
...
// create and show the alert dialog
    ...
    interface getSelectedItemsFromDialog {
        fun getColor(color: String)
        fun getPreferredTimings(timings: String)


    }

    interface getStringDataFromEditText {
